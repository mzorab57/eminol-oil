...
import renwable from "/assets/img/bg/renwable.jpg";
import carbon from "/assets/img/bg/carbon.jpg";
import hydrogen from "/assets/img/bg/factory-producing-co2-pollution.jpg";
import geo from "/assets/img/bg/geo.jpg";

const sliderData = [
  {
    id: 4,
    name: "Geothermal",
    desp: "Using our decades of experience and innovative partnerships, we're working to unlock the next generation of geothermal energy.",
    img: geo,
  },
  {
    id: 1,
    name: "Renewable fuels",
    desp: "We're growing our feedstock business to produce renewable fuels and help our customers achieve their lower carbon ambitions.",
    img: renwable,
  },
  {
    id: 2,
    name: "Carbon capture",
    desp: "We're developing and deploying carbon capture, utilization and storage (CCUS) technologies, which experts agree are essential tools to making a lower carbon future possible.",
    img: carbon,
  },
  {
    id: 3,
    name: "Hydrogen",
    desp: "We're working to solve the technical challenges of transporting hydrogen over long-distances at a lower carbon intensity.",
    img: hydrogen,
  },
            ...
            {sliderData.map((item) => (
              <SwiperSlide key={item.id}>
                <div className="testimonal-info ak-style1">
                  <div className="slider-info py-20">
                    <div className="d-flex justify-content-between align-items-center ">
                      <div>
                        <h5 className="name text-4xl text-red-500">{item.name}</h5>
                  ...
                  <img
                    src={item.img}
                    alt="..."
                    className="testimaonial-slide-img mr-14  -skew-x-12"
                  />
                </div>
              </SwiperSlide>
            ))}
